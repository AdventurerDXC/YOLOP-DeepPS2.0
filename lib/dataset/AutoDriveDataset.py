...
class AutoDriveDataset(Dataset):
    ...
    def __init__(self, cfg, is_train, inputsize=640, transform=None):
        ...
        self.name_list = cfg.DATASET.TEST_SET
        for name in self.name_list:
            # self.img_root_list.append(self.img_root / name / 'images' / self.indicator)
            mask_root_list.append(self.img_root / name / 'seg_labels' / indicator)
            # self.det_root_list.append(self.img_root / name / 'det_labels' / self.
