...
_C.DATASET.DATAROOT = '/home/xcdai/文档/Deep_Learning/YOLOP/lib/dataset/DeepPS/img_root'                # the path of images folder
_C.DATASET.LABELROOT = '/home/xcdai/文档/Deep_Learning/YOLOP/lib/dataset/DeepPS/det_annotations'      # the path of det_annotations folder
_C.DATASET.MASKROOT = ''    # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = ''    # the path of ll_seg_annotations folder
_C.DATASET.DATASET = 'DeepPS'
